    ...
    <aside className="sticky top-0 flex h-screen w-[248px] shrink-0 flex-col gap-4 border-r border-border bg-card px-3 py-4">
      ...
      <div className="mt-auto flex flex-col gap-2 border-t border-border px-2.5 pt-3">
        <p className="text-[10.5px] leading-snug text-muted-foreground/80">
          Local POC build — Phase 7 (Candidate Management). Positions,
          Templates, and Candidates are live — AI-assisted JD analysis, draft
          generation, per-question regenerate (Claude or Gemini free tier),
          and starting a Session locks the Template version in use
          (ADR-008); Interviews/Reports are scaffolded and filled in over
          later phases.
        </p>
      </div>
    </aside>
